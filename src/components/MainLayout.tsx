    ...
    <div className="main-layout">
      ...
      {!isAssistantOpen && (
        <button
          ...
          className="fixed right-6 bottom-6 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white rounded-full p-3 shadow-lg transition-transform hover:scale-110 z-30 group"
